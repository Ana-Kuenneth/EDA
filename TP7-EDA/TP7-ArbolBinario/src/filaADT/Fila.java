...
public class Fila {
    ...
    private class Nodo{
        private ArbolBinario pedido;
        private Nodo nodoSiguiente;
        
        public Nodo(ArbolBinario pedido){
            this.pedido = pedido;
            this.nodoSiguiente=null;
        }

        public ArbolBinario getPedido() {
            return pedido;
        }

        public void setPedido(ArbolBinario pedido) {
            this.pedido = pedido;
        }
    ...
    public Fila enfila(ArbolBinario pedido){
